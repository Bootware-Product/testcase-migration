...
import jp.bootware.product.testcasemigrationcore.application.UnitTestWriter;
...
@SpringBootTest
class TestUnitTestConverterTestCase {

  @Autowired
  UnitTestJavaDocAnalyzer parser;

  @Autowired
  UnitTestWriter converter;
  ...
  public void test() throws IOException {
    ...
    Path csvPath = converter.writeCsv(jsonPath, output.resolve("testConverter.csv"));
  }
}